...
export interface BicsRecord {
  ...
  fttb_actual_ta_date?: string;
  rollout_solution?: string;
  hws_po_release?: string;
  hws_cip?: string;
  hws_target_completion?: string;
  hws_actual_completion?: string;
  actual_ta_network?: string;
  ta_network_vs_warpp?: string;
  ta_date_network?: string;
  actual_ta?: string;
  actual_fa?: string;
  warpp_pcn?: string;
